...
const supportData = [
  {
    type: "Network Issue",
    icon: <Wifi size={32} />,
    contact: { number: "+880 1712-577194", email: "network@ssn.com" },
    color: "from-blue-400 to-blue-600",
  },
  {
    type: "Payment Issue",
    icon: <CreditCard size={32} />,
    contact: { number: "+880 1712-577194", email: "payment@ssn.com" },
    color: "from-green-400 to-green-600",
  },
  {
    type: "New Connection Issue",
    icon: <Plug size={32} />,
    contact: { number: "+880 1712-577194", email: "newconnection@ssn.com" },
    color: "from-purple-400 to-purple-600",
  },
  {
    type: "Billing Issue",
    icon: <FileText size={32} />,
    contact: { number: "+880 1712-577194", email: "billing@ssn.com" },
    color: "from-yellow-400 to-yellow-600",
  },
  {
    type: "Technical Support",
    icon: <Wrench size={32} />,
    contact: { number: "+880 1712-577194", email: "tech@ssn.com" },
    color: "from-red-400 to-red-600",
  },
  {
    type: "Service Upgrade",
    icon: <ArrowUp size={32} />,
    contact: { number: "+880 1712-577194", email: "upgrade@ssn.com" },
    color: "from-pink-400 to-pink-600",
  },
  {
    type: "Complaint",
    icon: <AlertTriangle size={32} />,
    contact: { number: "+880 1712-577194", email: "complaint@ssn.com" },
    color: "from-indigo-400 to-indigo-600",
  },
  {
    type: "Feedback/Suggestion",
    icon: <MessageCircle size={32} />,
    contact: { number: "+880 1712-577194", email: "feedback@ssn.com" },
