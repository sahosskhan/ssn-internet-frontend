  ...
  return (
    <div className="bg-gradient-to-br from-[#0e1026] via-[#1f0b3a] to-[#0b253e] text-gray-100 min-h-screen">
      ...
      <section className="py-20 px-6 text-center">
        <h1 className="text-5xl sm:text-6xl font-bold mb-4 animate-fadeIn">
          About SSN Internet
        </h1>
        <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto animate-fadeIn delay-200">
      ...
      {/* Our Story Section */}
      <section className="py-16 px-6 max-w-6xl mx-auto animate-fadeIn delay-400">
        <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 shadow-lg hover:shadow-xl transition">
...
<section className="py-16 px-6 max-w-6xl mx-auto animate-fadeIn delay-600">
  <h2 className="text-5xl sm:text-6xl font-bold mb-12 text-center">Our Collaborations & Partners</h2>
  ...
  <div className="overflow-hidden relative">
    <div className="flex animate-marquee whitespace-nowrap gap-10">
      {collaborations.map((partner, index) => (
        <div
          key={index}
          className="bg-white/10 backdrop-blur-lg p-4 rounded-2xl shadow-lg flex flex-col items-center justify-center min-w-[180px]"
        >
          <img
            src={partner.logo} // logo url
            alt={partner.name}
            className="w-20 h-20 object-contain mb-2"
          />
          <h3 className="text-white font-semibold text-center">{partner.name}</h3>
        </div>
      ))}
    </div>
  </div>
...
{/* Team Section - Table Format */}
<section className="py-16 px-6 max-w-6xl mx-auto animate-fadeIn delay-800">
  <h2 className="text-5xl sm:text-6xl font-bold text-center mb-4">Meet Our Team</h2>
